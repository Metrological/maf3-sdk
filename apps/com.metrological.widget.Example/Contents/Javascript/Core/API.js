...
log(Date.format(new Date(), DateFormat.RFC2822, 'fr'));
log(Date.parse('di, 13 aug. 2013 00:00:00 +0200', DateFormat.RSS, 'nl'));
log(Date.parse((new Date()).toString(), DateFormat.JS));
*/
