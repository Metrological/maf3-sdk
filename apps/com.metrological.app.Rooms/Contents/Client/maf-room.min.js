...
"leaved",{hash:a,user:b,data:k}));break;case "d":-1!==h[a].indexOf(b)&&c.call(l,"data",{hash:a,user:b,data:k});break;case "p":-1===h[a].indexOf(b)&&(h[a].push(b),c.call(l,"joined",{hash:a,user:b,data:k}));break;case "e":c.call(l,"error",{hash:a,user:b,err:d.c})}}function k(){t=!1;p++;b&&(b.onopen=b.onmessage=b.onclose=null);b=null;for(var a in g){var d=g[a];d.joined=q;d.user=q;h[a].length=0}setTimeout(v,u*p)}function v(){var a;if(!(a=b))a:{try{a=new WebSocket("ws://ws"+(s?"-sdk":"")+".metrological.com/");
