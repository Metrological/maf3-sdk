var NAF=this.NAF={},WebApp=this.WebApp={},version="1.0.7s4c2r83";this.callId=this.params=this.isNotification=null;include("naf-webapp/"+version+"/naf-webapp.min.js");var model=new WebApp.Model,controller=new WebApp.Controller(model);controller.registerPMRPC();
