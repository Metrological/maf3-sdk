...
var NDSPlayer=function(){function c(b){p!==b&&(fire.call(a,"onStateChange",{state:b}),p=b)}function q(){d&&!h?(screen.log("START"),VideoPlayer.start(),5>n?(g=setTimeout(q,1E3*(5-n)),n++):(n=0,g&&(clearTimeout(g),g=null),c(Player.state.ERROR))):g&&(screen.log("STARTED"),n=0,clearTimeout(g),g=null)}function m(b){return!0}var a=this,l=Player.prototype.bounds,k=l,h=!1,e=!1,f=!1,d=null,p=null,n=0,g;a.subscribers={};VideoPlayer&&(VideoPlayer.onPlaybackStarted=function(){e&&d&&VideoPlayer&&(h=!0,screen.log("INFOLOADED"),
c(Player.state.INFOLOADED))},VideoPlayer.onPlaybackEnd=function(){e&&d&&(screen.log("EOF"),c(Player.state.EOF))},VideoPlayer.onPlaybackUnexpectedStop=function(){e&&d&&h&&(screen.log("STOPPED"),c(Player.state.STOP),screen.log("BOUNDS:"+JSON.stringify(a.bounds)+", "+JSON.stringify(k)),k[3]!==a.bounds[3]&&(a.bounds=k))},VideoPlayer.onPlaybackError=function(){e&&d&&(screen.log("ERROR"),c(Player.state.ERROR))});TVContext&&(TVContext.onContentSelectionSucceeded=function(){e||(screen.log("CHANNEL CHANGE"),
...
setter(a,"volume",function(b){if(AudioPlayer)try{AudioPlayer.setVolume(parseInt(100*b,10))}catch(a){}});getter(a,"src",function(){return e&&d});setter(a,"src",function(b){if(b&&VideoPlayer&&!d){h=!1;p=null;f=!1;g&&(clearTimeout(g),g=null);screen.log("BUFFERING");c(Player.state.BUFFERING);if(!e)try{VideoPlayer.grab(),e=!0}catch(a){return}else if(d&&VideoPlayer.status!==VideoPlayer.PLAYER_STATUS_STOPPED)try{VideoPlayer.stop()}catch(n){}try{screen.log("LOAD"),VideoPlayer.setURI(b),d=b,q.delay(800)}catch(k){screen.log("LOAD ERROR")}}else if(d&&
VideoPlayer){h=!1;p=d=null;f=!1;g&&(clearTimeout(g),g=null);if(VideoPlayer.status!==VideoPlayer.PLAYER_STATUS_STOPPED)try{VideoPlayer.stop()}catch(l){}screen.log("STOP");c(Player.state.STOP);(function(){if(e&&!d){e=!1;try{VideoPlayer.ungrab()}catch(b){}}}).delay(800)}});getter(a,"paused",function(){return f});setter(a,"paused",function(b){if(e&&VideoPlayer)if(!1===b&&!0===f)try{VideoPlayer.status!==VideoPlayer.PLAYER_STATUS_STOPPED?VideoPlayer.resume():VideoPlayer.start(),f=!1}catch(a){}else if(!0===
b&&!1===f)try{VideoPlayer.pause(),f=!0}catch(d){}screen.log(f?"PAUSED":"RESUME");c(f?Player.state.PAUSE:Player.state.PLAY)});getter(a,"bounds",function(){return VideoPlayer?[VideoPlayer.x,VideoPlayer.y,VideoPlayer.width,VideoPlayer.height]:l});setter(a,"bounds",function(b){var a=b&&b.length||0;1<a&&VideoPlayer&&(4===a&&VideoPlayer.setSize(b[2],b[3]),VideoPlayer.move(b[0],b[1]));k=b})};NDSPlayer.prototype=new Player;NDSPlayer.prototype.constructor=NDSPlayer;plugins.players.push(new NDSPlayer);
...
var NDSProfile=function(){function c(a){switch(a){case "adult":a=User.ADULT_PIN;break;case "youth":a=User.ADULT_PIN;break;default:a=User.MASTER_PIN}try{return UserData&&UserData.isPINSet(a)||!1}catch(c){return!1}}var q=++Profile.__instances__,m=!1,a=0,l=function(a){try{return UserData&&UserData.get(a)}catch(c){}return null};getter(this,"id",function(){return md5(this.household+q)});getter(this,"name",function(){return l(UserData.KEY_PROFILE_USER_NAME)||""});getter(this,"ageRating",function(){return l(UserData.KEY_PROFILE_PARENTAL_AGE)||
...
getter(this,"locked",function(){return m});getter(this,"hasPIN",function(){return c});var k=function(){m=!1;a=0},h=function(a,c){try{return User&&User.challengePINCode(a,c)}catch(e){}return null},e=function(d,e){if(!c(e))return!0;if(m)return!1;var f;switch(e){case "adult":f=h(User.ADULT_PIN,d);break;case "youth":f=h(User.YOUTH_PIN,d);break;default:f=h(User.MASTER_PIN,d)}switch(f){case User.PIN_SUCCESS:return m=!1,!0;case User.PIN_RETRY:return a++,3===a&&(m=!0,k.delay(9E5)),!1;case User.PIN_NOT_SET:case User.PIN_LOCKED:return!1;
default:return!1}};getter(this,"validatePIN",function(){return e});var f=new GenericStorage("pp",!0);getter(this,"passport",function(){return f})};NDSProfile.prototype=new Profile;NDSProfile.prototype.constructor=NDSProfile;plugins.profiles.push(new NDSProfile);var resetNDSPlayer=function(){var c=plugins.players[0];c&&(c.src="")};Application&&(Application.onHide=function(){resetNDSPlayer()});window.addEventListener("unload",function(){resetNDSPlayer()});
