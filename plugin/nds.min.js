...
var syncProgramData=function(){var c=MAE.blocked&&plugins.players[0];timerProgramData&&(clearTimeout(timerProgramData),timerProgramData=void 0);currentChannel=TVContext&&TVContext.getCurrentChannel();MAE.blocked&&-1!==MAE.blocked.indexOf(currentChannel.number)?c&&(c.hide(),c.muted=!0,currentProgram=void 0):(c&&c.muted&&(c.show(),c.muted=!1),currentProgram=currentChannel&&currentChannel.getCurrentProgram());timerProgramData=setTimeout(syncProgramData,1E3*currentProgram.duration)},NDSPlayer=function(){function c(b){q!==
b&&(fire.call(a,"onStateChange",{state:b}),q=b)}function k(){fire.call(a,"onTimeChange")}function r(){e&&!l?(VideoPlayer.start(),p<t?(f=setTimeout(r,1E3*(t-p)),p++):(p=0,f&&(clearTimeout(f),f=null),c(Player.state.ERROR))):f&&(p=0,clearTimeout(f),f=null)}function m(b){return!0}var a=this,s=Player.prototype.bounds,g=s,l=!1,d=!1,h=!1,e=null,q=null,t=10,p=0,f,n;a.subscribers={};VideoPlayer&&(VideoPlayer.onPlaybackStarted=function(){d&&e&&VideoPlayer&&(l=!0,c(Player.state.INFOLOADED))},VideoPlayer.onPlaybackEnd=
function(){d&&e&&c(Player.state.EOF)},VideoPlayer.onPlaybackUnexpectedStop=function(){d&&e&&l&&(c(Player.state.STOP),g[3]!==a.bounds[3]&&(a.bounds=g))},VideoPlayer.onPlaybackError=function(){d&&e&&c(Player.state.ERROR)});TVContext&&(TVContext.onContentSelectionSucceeded=function(){d||(syncProgramData(),fire.call(a,"onChannelChange"),g[3]!==a.bounds[3]&&(a.bounds=g))});getter(a,"id",function(){return Player.TV});getter(a,"type",function(){return Player.type.VIDEO});getter(a,"supports",function(){return m});
...
setter(a,"muted",function(b){if(AudioPlayer)try{AudioPlayer.mute(!0===b)}catch(a){}});getter(a,"volume",function(){if(AudioPlayer)try{return AudioPlayer.level/100}catch(b){return 1}else return 1});setter(a,"volume",function(b){if(AudioPlayer)try{AudioPlayer.setVolume(parseInt(100*b,10))}catch(a){}});getter(a,"src",function(){return d&&e});setter(a,"src",function(b){if(b&&VideoPlayer&&!e){l=!1;q=null;h=!1;f&&(clearTimeout(f),f=null);c(Player.state.BUFFERING);if(!d)try{VideoPlayer.grab(),d=!0}catch(a){return}else if(e&&
VideoPlayer.status!==VideoPlayer.PLAYER_STATUS_STOPPED)try{VideoPlayer.stop()}catch(g){}try{VideoPlayer.setURI(b),e=b,r.delay(800)}catch(k){}}else if(e&&VideoPlayer){l=!1;q=e=null;h=!1;n&&(clearInterval(n),n=null);f&&(clearTimeout(f),f=null);if(VideoPlayer.status!==VideoPlayer.PLAYER_STATUS_STOPPED)try{VideoPlayer.stop()}catch(m){}c(Player.state.STOP);(function(){if(d&&!e){d=!1;try{VideoPlayer.ungrab()}catch(b){}}}).delay(800)}});getter(a,"paused",function(){return h});setter(a,"paused",function(b){if(d&&
VideoPlayer)if(!1===b&&!0===h)try{VideoPlayer.status!==VideoPlayer.PLAYER_STATUS_STOPPED?VideoPlayer.resume():VideoPlayer.start(),h=!1}catch(a){}else if(!0===b&&!1===h)try{VideoPlayer.pause(),h=!0}catch(e){}h?n&&(clearInterval(n),n=null):n=setInterval(k,1E3);c(h?Player.state.PAUSE:Player.state.PLAY)});getter(a,"bounds",function(){return VideoPlayer?[VideoPlayer.x,VideoPlayer.y,VideoPlayer.width,VideoPlayer.height]:s});setter(a,"bounds",function(b){var a=b&&b.length||0;1<a&&VideoPlayer&&(4===a&&VideoPlayer.setSize(b[2],
b[3]),VideoPlayer.move(b[0],b[1]));g=b})};NDSPlayer.prototype=new Player;NDSPlayer.prototype.constructor=NDSPlayer;plugins.players.push(new NDSPlayer);var NDSCOUNTRIES={eng:"en",enm:"en",ned:"nl",nld:"nl",dut:"nl",che:"ch",fre:"fr",fra:"fr",ger:"de",deu:"de",irl:"ie"},NDSLANGUAGES={ang:"en",eng:"en",enm:"en",ned:"nl",nld:"nl",dut:"nl",fre:"fr",fra:"fr",frm:"fr",fro:"fr",ger:"de",deu:"de",gmh:"de",goh:"de",ita:"it",irl:"en",gla:"en",gle:"en"};plugins.storage=new CookieStorage;
