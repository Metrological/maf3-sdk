...
b&&(fire.call(a,"onStateChange",{state:b}),q=b)}function k(){fire.call(a,"onTimeChange")}function r(){e&&!l?(VideoPlayer.start(),5>p?(f=setTimeout(r,1E3*(5-p)),p++):(p=0,f&&(clearTimeout(f),f=null),c(Player.state.ERROR))):f&&(p=0,clearTimeout(f),f=null)}function m(b){return!0}var a=this,s=Player.prototype.bounds,g=s,l=!1,d=!1,h=!1,e=null,q=null,p=0,f,n;a.subscribers={};VideoPlayer&&(VideoPlayer.onPlaybackStarted=function(){d&&e&&VideoPlayer&&(l=!0,c(Player.state.INFOLOADED))},VideoPlayer.onPlaybackEnd=
