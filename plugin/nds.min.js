...
"muted",function(){try{return AudioPlayer&&!0===AudioPlayer.muted||!1}catch(b){return!1}});setter(a,"muted",function(b){if(AudioPlayer)try{AudioPlayer.mute(!0===b)}catch(a){}});getter(a,"volume",function(){if(AudioPlayer)try{return AudioPlayer.level/100}catch(b){return 1}else return 1});setter(a,"volume",function(b){if(AudioPlayer)try{AudioPlayer.setVolume(parseInt(100*b,10))}catch(a){}});getter(a,"src",function(){return k&&g});setter(a,"src",function(b){if(b&&VideoPlayer&&!g){h=!1;r=null;e=!1;f&&
(clearTimeout(f),f=null);d(Player.state.BUFFERING);if(!k)try{VideoPlayer.grab(),k=!0}catch(a){return}else if(g&&VideoPlayer.status!==VideoPlayer.PLAYER_STATUS_STOPPED)try{VideoPlayer.stop()}catch(c){}try{VideoPlayer.setURI(b),g=b,l.delay(800)}catch(m){}}else if(g&&VideoPlayer){h=!1;r=g=null;e=!1;n&&(clearInterval(n),n=null);f&&(clearTimeout(f),f=null);if(VideoPlayer.status!==VideoPlayer.PLAYER_STATUS_STOPPED)try{VideoPlayer.stop()}catch(p){}d(Player.state.STOP);(function(){if(k&&!g){k=!1;try{VideoPlayer.ungrab()}catch(b){}}}).delay(800)}});
getter(a,"paused",function(){return e});setter(a,"paused",function(b){if(k&&VideoPlayer)if(!1===b&&!0===e)try{VideoPlayer.status!==VideoPlayer.PLAYER_STATUS_STOPPED?VideoPlayer.resume():VideoPlayer.start(),e=!1}catch(a){}else if(!0===b&&!1===e)try{VideoPlayer.pause(),e=!0}catch(c){}e?n&&(clearInterval(n),n=null):n=setInterval(t,1E3);d(e?Player.state.PAUSE:Player.state.PLAY)});getter(a,"bounds",function(){return VideoPlayer?[VideoPlayer.x,VideoPlayer.y,VideoPlayer.width,VideoPlayer.height]:s});setter(a,
"bounds",function(b){var a=b&&b.length||0;1<a&&VideoPlayer&&(4===a&&VideoPlayer.setSize(b[2],b[3]),VideoPlayer.move(b[0],b[1]));m=b});getter(a,"notify",function(){return u})};NDSPlayer.prototype=new Player;NDSPlayer.prototype.constructor=NDSPlayer;plugins.players.push(new NDSPlayer);
