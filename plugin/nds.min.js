...
default:return!1}};getter(this,"validatePIN",function(){return d});var e=new GenericStorage("pp",!0);getter(this,"passport",function(){return e})};NDSProfile.prototype=new Profile;NDSProfile.prototype.constructor=NDSProfile;plugins.profile=NDSProfile;var resetNDSPlayer=function(){var c=plugins.players[0];c&&(c.src="")};Application&&(Application.onHide=function(){resetNDSPlayer()});window.addEventListener("unload",function(){resetNDSPlayer()});
