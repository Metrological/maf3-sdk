...
// All Rights Reserved.
NAF.conf={"debug":0,"upcPrice":false,"provideDefaultSettings":true,"mwReadyWaitTime":30,"isAppDefinedNormalMode":true,"chanlocsrc":"traxis","traxisidprefix":"CpeId","boRequestTimeout":25,"codcatalog":"root","enableHttpVod":false,"catchUpCategory":"","maxCODOrphans":10,"codOrphanTimeout":1800,"titleSchema":{"basic":["name","pictures","isAdult"],"extended":["name","shortName","shortSynopsis","longSynopsis","isViewable","isEntitled","isPreview","isAdult","ageRating","pictures","contents","events","previews",
"genres","seasonNum","episodeNum","episodeName","seriesName","isViewedCompletely","productionDate","broadcastDate","bookmark","productionLocations","actors","directors","customProperties"]},"vodSessionTearDownTimeout":1080,"vodEndPadding":95,"vodStartPadding":5,"parentGenres":["","MOVIE","NEWS","VARIETY & GAME SHOWS","SPORT","KIDS & YOUTH","MUSIC & DANCE","ARTS & CULTURE","CURRENT AFFAIRS","EDUCATIONAL","LEISURE","SPECIAL","ENTERTAINMENT","CRIME","TV SERIES","ADULT"],"eRouterIp":"192.168.0.1","eRouterAdminName":"admin",
"eRouterAdminPassword":"admin","eRouterRetry":0,"eRouterRetryInterval":10,"numhours":6,"refreshInterval":0,"refreshInterval0":3600,"fetchInitEventsInChunks":true,"eventsRefreshInChunks":20,"eventsRefreshTimeout":0,"maxChannelCategories":1,"reminderTime":2,"reminderRefreshInterval":7200,"tuneByChanLocator":true,"pretune":true,"previouspretunes":0,"followingpretunes":1,"teletextHandling":false,"langTimeOut":500,"chanUpDownKeyHandling":false,"startChannel":"CNN","initChannel":"lastViewed","setLastViewedWaitingTime":10,
"catchUpChannel":0,"maxPinAttempts":3,"pinRetryInterval":300,"pinAttemptsDuration":300,"profileAgeRating":0,"maxHistory":5,"maxHistoryDuration":0,"automaticBlockAdult":true,"blockUnratedTitleEvents":false,"standbyScheduledRecPadding":300,"useNewRecordingManager":true,"notificationInterval":1E3,"bufferUpdateInterval":300,"minDiagPollInterval":3E4,"genreData":JSON.stringify({"genres":[{"code":"1","name":"movie","subgenres":[]},{"code":"2","name":"news","subgenres":[]},{"code":"3","name":"show","subgenres":[]},
{"code":"4","name":"sports","subgenres":[]},{"code":"5","name":"children's","subgenres":[]},{"code":"6","name":"music","subgenres":[]},{"code":"7","name":"arts","subgenres":[]},{"code":"8","name":"social","subgenres":[]},{"code":"9","name":"education","subgenres":[]},{"code":"10","name":"leisure","subgenres":[]},{"code":"11","name":"special","subgenres":[]},{"code":"12","name":"entertainment","subgenres":[]},{"code":"13","name":"crime","subgenres":[]},{"code":"14","name":"series","subgenres":[]},
{"code":"15","name":"adult","subgenres":[]}]}),"applications":[{"id":"id1","name":"MetrologicalAppStore","shortSynopsis":"The Metrological App Store","isAdult":false,"isViewable":true,"isEntitled":true,"url":"http://widgets.metrological.com/dawn/pl/development/#","type":"store"}],"bkwdCompatibleNotifications":false,"maxRecommendations":30,"recommendationTimeout":1800,"maxSearches":2,"searchTimeout":1800,"defaultSearchSource":"all","tvType":"50hz","audioFormat":{"auto":"stereo","dolby":"ac3"},"SWUpdateProgInterval":1,
"mediawareip":"","channelRefreshInterval":0,"profileRefreshInterval":0,"enableCODCategorySingleFetch":true};NAF.conf.hdmiComponent=NAF.conf.tvType=="50hz"?{"1080p":"1080p50hz2d","1080i":"1080i50hz2d","720p":"720p50hz2d","576p":"576p50hz2d","auto":"576i25hz2d"}:{"1080p":"1080p60hz2d","1080i":"1080i30hz2d","720p":"720p60hz2d","480p":"480p60hz2d","auto":"480i30hz2d","preferred":"preferred"};
...
result:-1}}if(response.error)log.error("MAP-ERR: code="+response.error.code+" message="+response.error.message);if(callback){if(response.error)response={error:response.error.message,result:-1};callback(response.result,callbackParams)}xhttp.onreadystatechange=null;response=null;callbackParams=null;xhttp=null}};xhttp.send(null);reqObj=null;request=null;reqUrl=null}this.MapSetSplashEnabled=function(isSplash,callback,callbackParams){asyncMakeRequest("MapSetSplashEnabled",{enable:isSplash,callbackParams:callbackParams},
callback)};this.VidSetAnimationParameters=function(win,bAnim,dur,speeed,fps,callback){asyncMakeRequest("VidSetAnimationParameters",{"windowId":win,"bAnimate":bAnim,"duration":dur,"speed":speed,"fps":fps},callback)};this.VidPretune=function(win,aLocators,callback){asyncMakeRequest("VidPreTune",{"windowId":win,"LocatorArray":aLocators},callback)};this.VidStopPretune=function(win,aLocators,callback){asyncMakeRequest("VidStopPreTune",{"windowId":win},callback)};this.VidGetCurChan=function(callback){asyncMakeRequest("VidGetCurChan",
{},callback)};this.VidGetLastChan=function(callback){asyncMakeRequest("VidGetLastChan",{},callback)};this.VidSetLastViewedChan=function(chanId,callback){asyncMakeRequest("MapSetLastChan",{"id":chanId},callback)};this.VidGetStartChan=function(){return null};this.VidDetune=function(callback){asyncMakeRequest("VidDetune",{},callback)};this.VidGetChanCount=function(callback){asyncMakeRequest("VidGetChanCount",{},callback)};this.VidGetChannelList=function(platform,callback){asyncMakeRequest("VidGetChannelList",
{"platform":platform},callback)};this.VidSetVideoWinSize=function(x,y,w,h,bPIP,callback){asyncMakeRequest("VidSetVideoWinSize",{"x":x,"y":y,"w":w,"h":h,"bPIP":bPIP},callback)};this.VidEnableCC=function(bEnable,callback){asyncMakeRequest("VidSetCloseCap",{"enable":bEnable},callback)};this.VidGetAvailableAudioLang=function(callback){asyncMakeRequest("GetAvailableAudioLanguages",{},callback)};this.VidSetPrefAudioLang=function(lang,type,callback,callbackParams){var params=new Object;params["language"]=
lang;if(type||type!="")params["type"]=type;params.callbackParams=callbackParams;asyncMakeRequest("SetAudioLanguagePreference",params,callback)};this.VidGetPrefAudioLang=function(callback){asyncMakeRequest("GetAudioLanguagePreference",{},callback)};this.VidSetAudioLang=function(lang,callback,callbackParams){var params=new Object;params["language"]=lang;params.callbackParams=callbackParams;asyncMakeRequest("SetAudioLanguage",params,callback)};this.VidGetAudioLang=function(callback){asyncMakeRequest("GetAudioLanguage",
...
function(callback){if(callback)asyncMakeRequest("PvrGetCheckPoint",{},callback);else return makeRequest("PvrGetCheckPoint")};this.DvrSync=function(callback){if(callback)asyncMakeRequest("PvrSync",{},callback);else return makeRequest("PvrSync")};this.DvrRecord=function(loc,channelId,secs,t,d,start,repeat,fPad,bPad,locked,callback){var params=new Object;params["locator"]=loc;params["channelId"]=channelId;params["duration"]=secs;params["title"]=t;params["description"]=d;params["start"]=start;params["isPinLocked"]=
locked;if(fPad)params["frontPad"]=fPad;if(bPad)params["backPad"]=bPad;var crontabInterval;if(repeat!=0){var recordingDate;if(!start)recordingDate=new Date;else recordingDate=new Date(start*1E3);var repeatDays="";for(var i=0;i<repeat.length;i++)if(repeat[i]==7)repeatDays="0,"+repeatDays;else repeatDays+=repeat[i]+",";repeatDays=repeatDays.substring(0,repeatDays.length-1);crontabInterval=recordingDate.getMinutes()+" "+recordingDate.getUTCHours()+" * * "+repeatDays}if(crontabInterval)params["interval"]=
...
{"recordingId":recordingId,"position":bookmark},callback)};this.DvrSetViewState=function(recordingId,viewState,callback){asyncMakeRequest("PvrSetViewState",{"recordingId":recordingId,"ViewState":viewState},callback)};this.DvrAssetList=function(callback){asyncMakeRequest("PvrListRecording",{},callback)};this.DvrListRequests=function(callback){if(callback)asyncMakeRequest("PvrListRequests",{},callback);else return makeRequest("PvrListRequests")};this.DvrListOperations=function(callback){if(callback)asyncMakeRequest("PvrListOperations",
{},callback);else return makeRequest("PvrListOperations")};this.DvrListRecordings=function(callback){if(callback)asyncMakeRequest("PvrListRecordings",{},callback);else return makeRequest("PvrListRecordings")};this.DvrListRequestsOperationsRecordings=function(callback){if(callback)asyncMakeRequest("PvrBatchCommand",{"commands":["PvrListRequests","PvrListOperations","PvrListRecordings"]},callback);else return makeRequest("PvrBatchCommand","commands",["PvrListRequests","PvrListOperations","PvrListRecordings"])};
this.DvrGetRecords=function(cp,callback){if(callback)asyncMakeRequest("MapPvrGetRecords",{"checkPoint":cp},callback);else return makeRequest("MapPvrGetRecords","checkPoint",cp)};this.DvrGetConflicts=function(id,callback,callbackParams){var params=new Object;params={"opId":id};params.callbackParams=callbackParams;asyncMakeRequest("MapPvrGetConflicts",params,callback)};this.DvrPause=function(callback){asyncMakeRequest("PvrPlayTrick",{"speed":0},callback)};this.DvrResume=function(callback){asyncMakeRequest("PvrPlayTrick",
{"speed":100},callback)};this.DvrFastForward=function(speed,callback){asyncMakeRequest("PvrPlayTrick",{"speed":speed},callback)};this.DvrRewind=function(speed,callback){asyncMakeRequest("PvrPlayTrick",{"speed":-speed},callback)};this.DvrOffset=function(offset,callback){asyncMakeRequest("PvrPlaySkip",{"offset":offset},callback)};this.DvrDelete=function(loc,callback){asyncMakeRequest("PvrDeleteRecording",{"locator":loc},callback)};this.DvrDeleteAll=function(callback){asyncMakeRequest("PvrDeleteAll",
{},callback)};this.DvrDeleteRequest=function(id,callback){asyncMakeRequest("PvrDelete",{"requestId":id},callback)};this.DvrDeleteOperation=function(id,callback){asyncMakeRequest("PvrDelete",{"operationId":id},callback)};this.DvrDeleteOperations=function(ids,callback){var command={};command["operationIds"]=ids;asyncMakeRequest("PvrDelete",command,callback)};this.DvrDeleteRecording=function(id,callback){asyncMakeRequest("PvrDelete",{"recordingId":id},callback)};this.DvrCancelRequest=function(id,callback){asyncMakeRequest("PvrCancel",
{"requestId":id},callback)};this.DvrDeleteProtectOperation=function(id,state,callback,callbackParams){var params=new Object;params={"operationId":id,"protect":state};params.callbackParams=callbackParams;asyncMakeRequest("PvrDeleteProtect",params,callback)};this.DvrPinProtectOperation=function(id,state,callback,callbackParams){var params=new Object;params={"operationId":id,"protect":state};params.callbackParams=callbackParams;asyncMakeRequest("PvrPinProtect",params,callback)};this.DvrDeleteProtectRequest=
...
function(callback){asyncMakeRequest("VodPause",{},callback)};this.VodFastforward=function(num,denom,callback){asyncMakeRequest("VodFastforward",{"numerator":num,"denominator":denom},callback)};this.VodRewind=function(num,denom,callback){asyncMakeRequest("VodRewind",{"numerator":num,"denominator":denom},callback)};this.VodStop=function(callback){asyncMakeRequest("VodStop",{},callback)};this.VodGet=function(nam,callback){asyncMakeRequest("VodGet",{"name":nam},callback)};this.VodSet=function(nam,val,
callback){asyncMakeRequest("VodSet",{"name":nam,"value":val},callback)};this.VodPlaySkip=function(offset,callback){asyncMakeRequest("VodPlaySkip",{"offset":offset},callback)};this.VodResume=function(callback){asyncMakeRequest("VodFastforward",{"numerator":1,"denominator":1},callback)};this.ConfigGet=function(nm,callback,callbackParams){var params=new Object;params={"name":nm};if(callbackParams)params.callbackParams=callbackParams;asyncMakeRequest("ConfigGet",params,callback)};this.ConfigSet=function(nm,
val,callback){if(callback)asyncMakeRequest("ConfigSet",{"name":nm,"value":val},callback);else return makeRequest("ConfigSet","name",nm,"value",val)};this.GetMWConfig=function(section,key,callback){asyncMakeRequest("GetMWConfig",{"section":section,"key":key},callback)};this.GetKeyMap=function(callback){asyncMakeRequest("GetKeyMap",{},callback)};this.EmulateRemoteKey=function(kc,ks){if(!!ks)asyncMakeRequest("EmulateRemoteKey",{"KeyCode":kc,"KeyState":ks});else asyncMakeRequest("EmulateRemoteKey",{"KeyCode":kc})};
this.VerifyPin=function(profId,type,pin,callback,callbackParams){var params=new Object;params={"profile":profId,"type":type,"pin":pin};params.callbackParams=callbackParams;asyncMakeRequest("VerifyPin",params,callback)};this.ResetPin=function(profId,type,pin,newpin,callback,callbackParams){var params=new Object;params={"profile":profId,"type":type,"masterpin":pin,"newpin":newpin};params.callbackParams=callbackParams;asyncMakeRequest("ResetPin",params,callback)};this.GetPinState=function(profId,type){asyncMakeRequest("GetPinState",
...
asyncMakeRequest("MapSetVideoPortControlSettings",params,callback)};this.MapGetDolbyEnabled=function(callback){asyncMakeRequest("MapGetDolbyEnabled",{},callback)};this.MapSetDolbyEnabled=function(isDolby,callback,callbackParams){asyncMakeRequest("MapSetDolbyEnabled",{enable:isDolby,callbackParams:callbackParams},callback)};this.SetAudioOutputSettings=function(format,type,callback,callbackParams){format=NAF.conf.audioFormat[format];var params=new Object;params.id=format;if(type)params.type=type;params.callbackParams=
callbackParams;asyncMakeRequest("MapSetAudioOutputPortSettings",params,callback)};this.GetAudioOutputSettings=function(format,callback){params=new Object;if(format)params.type=format;asyncMakeRequest("MapGetAudioOutputPortSettings",params,callback)};this.SetAudioControlSettings=function(params,callback,callbackParams){if(callbackParams)params.callbackParams=callbackParams;asyncMakeRequest("MapSetAudioControlSettings",params,callback)};this.GetAudioOutputVolumeSettings=function(type,callback,callbackParams){var params=
new Object;if(callbackParams)params.callbackParams=callbackParams;if(type)params.type=type;asyncMakeRequest("MapGetAudioControlSettings",params,callback)};this.GetHDDAvailability=function(callback){asyncMakeRequest("MapGetHDDAvailability",{},callback)};this.MapGetSystemStatus=function(callback){asyncMakeRequest("MapGetSystemStatus",{},callback)};this.VidGetTSBInfo=function(callback){asyncMakeRequest("GetTSBInfo",{},callback)};this.VidGetTSBEventInfo=function(callback){asyncMakeRequest("GetTSBEventInfo",
...
"dqId",dqId)};this.SetDefaultStandbyMode=function(profileid,defaultStandby,callback,callbackParams){var params=new Object;if(callbackParams)params.callbackParams=callbackParams;params.profileId=profileid;if(profileid.indexOf("MasterProfile")!=-1)params.keyword="master";params.Settings=new Object;params.Settings.defaultStandby=defaultStandby;asyncMakeRequest("WriteProfile",params,callback)};this.GetDefaultStandbyMode=function(profileid,callback,callbackParams){var params=new Object;if(callbackParams)params.callbackParams=
callbackParams;params.profileId=profileid;params.Settings=["defaultStandby"];asyncMakeRequest("ReadProfile",params,callback)};this.GetStandbyModeSettings=function(callback){asyncMakeRequest("GetStandbyModeSettings",{},callback)};this.SetStandbyModeSettings=function(type,timeOut,startTime,endTime,weekDay,callback,callbackParams){var params=new Object;params={"autoStandby":type,"timeout":timeOut,"startTime":startTime,"endTime":endTime,"weekday":weekDay};if(callbackParams)params.callbackParams=callbackParams;
asyncMakeRequest("SetStandbyModeSettings",params,callback)};this.GetNetworks=function(callback){callback()};this.HideSplashScreen=function(){return};this.writePrefAudioLangs=function(profileid,prefAudioLangs,callback){var params=new Object;if(profileid.indexOf("MasterProfile")!=-1)params.keyword="master";params.profileId=profileid;params.Settings=new Object;params.Settings.prefAudioLangs=new Object;params.Settings.prefAudioLangs=prefAudioLangs;asyncMakeRequest("WriteProfile",params,callback)};this.readPrefAudioLangs=
...
"";diagResult.chanstatus.inversion=result.chanstatus.inversion!=null?result.chanstatus.inversion:"";diagResult.chanstatus.quality=result.chanstatus.quality!=null?result.chanstatus.quality:0;diagResult.chanstatus.level=result.chanstatus.level!=null?result.chanstatus.level:0}return diagResult}else return null}this.GetBootupState=function(callback){asyncMakeRequest("GetBootupState",{},callback)};this.MapGetStartUpMode=function(callback){asyncMakeRequest("MapGetStartUpMode",{},callback)};this.MapSetStartUpMode=
function(mode,callback){asyncMakeRequest("MapSetStartUpMode",{"mode":mode},callback)};this.RemotePairing=function(callback){asyncMakeRequest("MapRF4CBind",{},callback)};this.RemoteUnbind=function(id,callback){var params=new Object;params.bindingId=id;asyncMakeRequest("MapRF4CUnbind",params,callback)};this.RemotePairingAbort=function(callback){asyncMakeRequest("MapRF4CAbortBind",{},callback)};this.GetCacheUpdateStatus=function(callback){asyncMakeRequest("AppGetCacheUpdateStatus",{},callback)};this.SetCacheEventListener=
function(callback,params){asyncMakeRequest("AppSetCacheEventListener",params,callback)};this.UpdateCache=function(callback){asyncMakeRequest("AppUpdateCache",{},callback)};this.SwapCache=function(callback){asyncMakeRequest("AppSwapCache",{},callback)};this.AbortCaching=function(callback){asyncMakeRequest("AppAbortCaching",{},callback)};this.RemoveCacheEventListener=function(callback,params){asyncMakeRequest("AppRemoveCacheEventListener",params,callback)};this.GetCADecoderStatus=function(callback){asyncMakeRequest("MapGetNagraSystemInfomation",
{},callback)};this.MapSwUpdateCheck=function(callback){asyncMakeRequest("MapSwCheckUpdate",{},callback)};this.MapSwStartDownload=function(callback){asyncMakeRequest("MapSwStartDownload",{},callback)};this.MapSwInstall=function(callback){asyncMakeRequest("MapSwInstall",{},callback)};this.MapSwReboot=function(callback){asyncMakeRequest("MapSwReboot",{},callback)};this.MapSwDownloadProgress=function(callback){asyncMakeRequest("MapSwDownloadProgress",{},callback)};this.MapSetAgeRating=function(newAgeRating,
callback){newAgeRating=newAgeRating?newAgeRating:USER_AGE_RATING_OFF;param={};param.ageRating=newAgeRating;param.callbackParams=newAgeRating;asyncMakeRequest("MapSetUserAgeRating",param,callback)};this.MapSwReset=function(callback){asyncMakeRequest("MapSwReset",{},callback)}};
