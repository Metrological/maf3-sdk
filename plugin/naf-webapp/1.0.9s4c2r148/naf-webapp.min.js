...
// All Rights Reserved.
NAF.conf={"debug":0,"upcPrice":false,"provideDefaultSettings":true,"mwReadyWaitTime":30,"chanlocsrc":"traxis","traxisidprefix":"CpeId","codcatalog":"root","enableHttpVod":false,"catchUpCategory":"","maxCODOrphans":10,"codOrphanTimeout":1800,"titleSchema":{"basic":["name","pictures","isAdult"],"extended":["name","shortName","shortSynopsis","longSynopsis","isViewable","isEntitled","isPreview","isAdult","ageRating","pictures","contents","events","previews","genres","seasonNum","episodeNum","episodeName",
"seriesName","isViewedCompletely","productionDate","broadcastDate","bookmark","productionLocations","actors","directors"]},"vodSessionTearDownTimeout":1080,"eRouterIp":"192.168.0.1","eRouterAdminName":"admin","eRouterAdminPassword":"admin","eRouterRetry":0,"eRouterRetryInterval":10,"appCacheStartUpdate":10,"appCacheRetry":5,"appCacheRetryInterval":60,"numhours":6,"refreshInterval":0,"refreshInterval0":3600,"fetchInitEventsInChunks":true,"eventsRefreshInChunks":20,"eventsRefreshTimeout":200,"maxChannelCategories":1,
"reminderTime":1,"reminderRefreshInterval":7200,"tuneByChanLocator":true,"pretune":true,"previouspretunes":0,"followingpretunes":1,"teletextHandling":false,"langTimeOut":500,"chanUpDownKeyHandling":false,"startChannel":"CNN","initChannel":"lastViewed","setLastViewedWaitingTime":10,"catchUpChannel":0,"maxPinAttempts":3,"pinRetryInterval":300,"pinAttemptsDuration":300,"profileAgeRating":0,"maxHistory":5,"maxHistoryDuration":0,"automaticBlockAdult":true,"blockUnratedTitleEvents":true,"wakeuptime":120,
"prerecordwakeuptime":3,"useNewRecordingManager":true,"genreData":JSON.stringify({"genres":[{"code":"1","name":"movie","subgenres":[]},{"code":"2","name":"news","subgenres":[]},{"code":"3","name":"show","subgenres":[]},{"code":"4","name":"sports","subgenres":[]},{"code":"5","name":"children's","subgenres":[]},{"code":"6","name":"music","subgenres":[]},{"code":"7","name":"arts","subgenres":[]},{"code":"8","name":"social","subgenres":[]},{"code":"9","name":"education","subgenres":[]},{"code":"10","name":"leisure",
"subgenres":[]},{"code":"11","name":"special","subgenres":[]},{"code":"12","name":"entertainment","subgenres":[]},{"code":"13","name":"crime","subgenres":[]},{"code":"14","name":"series","subgenres":[]},{"code":"15","name":"adult","subgenres":[]}]}),"applications":[{"id":"id1","name":"MetrologicalAppStore","shortSynopsis":"The Metrological App Store","isAdult":false,"isViewable":true,"isEntitled":true,"url":"http://widgets.metrological.com/dawn/pl/production/","type":"store"}],"bkwdCompatibleNotifications":false,
"maxRecommendations":30,"recommendationTimeout":1800,"maxSearches":0,"searchTimeout":1800,"defaultSearchSource":"all","tvType":"50hz","audioFormat":{"auto":"stereo","dolby":"ac3"},"SWUpdateProgInterval":1,"mediawareip":"","channelRefreshInterval":0,"profileRefreshInterval":0,"enableCODCategorySingleFetch":true,"enableSWDownload":false};
...
new Date;var data=iStr.split("-");if(data.length!=3){throw new Error("ERROR: "+iStr+" format is incorrect. Ensure the date format follows 'YYY-MM-DD'.");return null}var year=data[0];var month=parseInt(data[1])-1;var day=data[2];if(isNaN(year)||(isNaN(month)||isNaN(day))){throw new Error("ERROR: "+iStr+" format is incorrect. Ensure the date format follows 'YYY-MM-DD'.");return}JSDate.setYear(year);JSDate.setMonth(month);JSDate.setDate(day);return JSDate},clearTimer:function(timer){if(timer){clearTimeout(timer);
...
NAF.Map=function(init,mediawareip){var RETRY_INTERVAL=1E4;var log=init.log;var mwip=mediawareip;var rid=1;var jsonVersion="2.0";var source;var that=this;var USER_AGE_RATING_OFF=1001;function internalHandler(event,message,error){var obj;try{obj=JSON.parse(event.data)}catch(e){log.error("server-sent event parsing failed, "+"event handler not invoked."+e);error("Invalid server-sent event");return}if(isValidMWEvent(obj))message(obj);else{log.error("server-sent event is not a valid MW event, "+"event handler not invoked.");
error("Invalid server-sent event")}function isValidMWEvent(obj){return typeof obj.method!=="undefined"}}this.SetAsyncEventHandlers=function(open,message,error){source=new EventSource("/server-sent-events");source.onopen=open;source.onmessage=function(evt){internalHandler(evt,message,error)};source.onerror=function(evt){var msg;switch(evt.target.readyState){case EventSource.CONNECTING:msg="Eventsource reconnecting.";break;case EventSource.CLOSED:msg="Eventsource closed. Creating a new one.";setTimeout(function(){that.SetAsyncEventHandlers(open,
message,error)},RETRY_INTERVAL);break}error(msg)}};function makeRequest(){var ajax=new XMLHttpRequest;var reqObj=new Object;reqObj.method=arguments[0];reqObj.id=rid++;reqObj.jsonrpc=jsonVersion;var params=new Object;for(var i=1;i<arguments.length;i+=2){var paramName=arguments[i];var paramValue=arguments[i+1];params[paramName]=paramValue}reqObj.params=params;var request=JSON.stringify(reqObj);var reqUrl="/ajax?"+encodeURI(request);if(typeof mwip!="undefined"&&mwip!="")reqUrl="http://"+mwip+reqUrl;
log.debug("MAP-REQ: "+request);ajax.open("GET",reqUrl,false);ajax.setRequestHeader("Content-Type","application/json;charset=UTF-8");ajax.send(null);var response;try{response=JSON.parse(ajax.responseText)}catch(e){response={error:e,result:-1}}if(response.error)log.error("MAP-ERR: code="+response.error.code+" message="+response.error.message);else if(log.getCurrLevel()<=4)log.debug("MAP-RES: status="+ajax.status+" response="+ajax.responseText.substr(0,80));else log.debug("MAP-RES: status="+ajax.status+
" response="+ajax.responseText);return response.result}function asyncMakeRequest(method,params,callback){var callbackParams=params.callbackParams;delete params.callbackParams;var xhttp=new XMLHttpRequest;var reqObj=new Object;reqObj.method=method;reqObj.id=rid++;reqObj.jsonrpc=jsonVersion;if(params&&JSON.stringify(params)!="{}")reqObj.params=params;var request=JSON.stringify(reqObj);var reqUrl="/ajax?"+encodeURI(request);if(typeof mwip!="undefined"&&mwip!="")reqUrl="http://"+mwip+reqUrl;log.debug("MAP-ASYNC-REQ: "+
request);xhttp.open("GET",reqUrl,true);xhttp.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhttp.onreadystatechange=function(){if(xhttp.readyState===4){var response;try{if(xhttp.status==200)if(log.getCurrLevel()<=4)log.debug("MAP-ASYNC-RESPONSE: SUCCESS "+xhttp.responseText.substr(0,200));else log.debug("MAP-ASYNC-RESPONSE: SUCCESS "+xhttp.responseText);else log.debug("MAP-ASYNC-RESPONSE: ERROR "+xhttp.responseText);response=JSON.parse(xhttp.responseText)}catch(e){response={error:e,
result:-1}}if(response.error)log.error("MAP-ERR: code="+response.error.code+" message="+response.error.message);if(callback){if(response.error)response={error:response.error.message,result:-1};callback(response.result,callbackParams)}xhttp.onreadystatechange=null;response=null;callbackParams=null;xhttp=null}};xhttp.send(null);reqObj=null;request=null;reqUrl=null}this.VidSetAnimationParameters=function(win,bAnim,dur,speeed,fps,callback){asyncMakeRequest("VidSetAnimationParameters",{"windowId":win,
"bAnimate":bAnim,"duration":dur,"speed":speed,"fps":fps},callback)};this.VidPretune=function(win,aLocators,callback){asyncMakeRequest("VidPreTune",{"windowId":win,"LocatorArray":aLocators},callback)};this.VidStopPretune=function(win,aLocators,callback){asyncMakeRequest("VidStopPreTune",{"windowId":win},callback)};this.VidGetCurChan=function(callback){asyncMakeRequest("VidGetCurChan",{},callback)};this.VidGetLastChan=function(callback){asyncMakeRequest("VidGetLastChan",{},callback)};this.VidSetLastViewedChan=
function(chanId,callback){asyncMakeRequest("MapSetLastChan",{"id":chanId},callback)};this.VidGetStartChan=function(){return null};this.VidDetune=function(callback){asyncMakeRequest("VidDetune",{},callback)};this.VidGetChanCount=function(callback){asyncMakeRequest("VidGetChanCount",{},callback)};this.VidGetChannelList=function(platform,callback){asyncMakeRequest("VidGetChannelList",{"platform":platform},callback)};this.VidSetVideoWinSize=function(x,y,w,h,bPIP,callback){asyncMakeRequest("VidSetVideoWinSize",
{"x":x,"y":y,"w":w,"h":h,"bPIP":bPIP},callback)};this.VidEnableCC=function(bEnable,callback){asyncMakeRequest("VidSetCloseCap",{"enable":bEnable},callback)};this.VidGetAvailableAudioLang=function(callback){asyncMakeRequest("GetAvailableAudioLanguages",{},callback)};this.VidSetPrefAudioLang=function(lang,type,callback,callbackParams){var params=new Object;params["language"]=lang;if(type||type!="")params["type"]=type;params.callbackParams=callbackParams;asyncMakeRequest("SetAudioLanguagePreference",
params,callback)};this.VidGetPrefAudioLang=function(callback){asyncMakeRequest("GetAudioLanguagePreference",{},callback)};this.VidSetAudioLang=function(lang,callback,callbackParams){var params=new Object;params["language"]=lang;params.callbackParams=callbackParams;asyncMakeRequest("SetAudioLanguage",params,callback)};this.VidGetAudioLang=function(callback){asyncMakeRequest("GetAudioLanguage",{},callback)};this.VidSetResolution=function(port,res,callback){asyncMakeRequest("VidSetResolution",{"port":port,
"resolution":res},callback)};this.VidGetAvailableSubtitleLang=function(callback){asyncMakeRequest("GetAvailableSubtitleLanguages",{},callback)};this.VidSetPrefSubtitleLang=function(langs,type,callback,callbackParams){var params=new Object;params["language"]=langs;params["type"]=type;params.callbackParams=callbackParams;asyncMakeRequest("SetSubtitleLanguagePreference",params,callback)};this.VidGetPrefSubtitleLang=function(callback){asyncMakeRequest("GetSubtitleLanguagePreference",{},callback)};this.VidGetSubtitleAvailability=
function(callback){asyncMakeRequest("GetSubtitleAvailability",{},callback)};this.VidEnableSubtitle=function(bo,callback){var params=new Object;params["enable"]=bo;asyncMakeRequest("EnableSubtitle",params,callback)};this.VidSetSubtitleLang=function(langs,callback,callbackParams){var params=new Object;params["language"]=langs;params.callbackParams=callbackParams;asyncMakeRequest("SetSubtitleLanguage",params,callback)};this.VidGetSubtitleLang=function(callback){asyncMakeRequest("GetSubtitleLanguage",
{},callback)};this.IsSubtitleEnabled=function(callback){asyncMakeRequest("IsSubtitleEnabled",{},callback)};this.VidSetPrefTeletextLang=function(lang,type,callback,callbackParams){log.warn("VidSetPrefTeletextLang(): Not yet supported.");return};this.VidGetPrefTeletextLang=function(callback){log.warn("VidGetPrefTeletextLang(): Not yet supported.");return};this.IsTeletextEnabled=function(callback){asyncMakeRequest("IsTeletextEnabled",{},callback)};this.EnableTeletext=function(enable,callback){asyncMakeRequest("EnableTeletext",
{"enable":enable},callback)};this.IsTeletextAvailable=function(callback){asyncMakeRequest("IsTeletextAvailable",{},callback)};this.VidSetTeletextLang=function(lang,type,callback,callbackParams){log.warn("VidSetTeletextLang(): Not yet supported.");return};this.VidGetTeletextLang=function(callback){log.warn("VidGetTeletextLang(): Not yet supported.");return};this.VidSpeakerMute=function(isBlocked,callback){asyncMakeRequest("VidSpeakerMute",{"flag":isBlocked},callback)};this.VidDisplayVideoOn=function(isBlocked,
callback){asyncMakeRequest("VidDisplayVideoOn",{"flag":isBlocked},callback)};this.DlnaSetDeviceName=function(name,type,callback){if(callback)asyncMakeRequest("MapDLNASetDeviceName",{"name":name,"type":type},callback);else return makeRequest("MapDLNASetDeviceName","name",name,"type",type)};this.DlnaGetDeviceName=function(type,callback){if(callback)asyncMakeRequest("MapDLNAGetDeviceName",{"type":type},callback);else return makeRequest("MapDLNAGetDeviceName","type",type)};this.MapDLNAGetActiveDevices=
function(params,callback){if(callback)asyncMakeRequest("MapDLNAGetActiveDevices",{"type":params},callback);else return makeRequest("MapDLNAGetActiveDevices","type",params)};this.MapDLNAGetContainer=function(devid,containerId,containerType,filter,start,count,sort,callback){if(callback)asyncMakeRequest("MapDLNAGetContainer",{"id":devid,"containerId":containerId,"containerType":containerType,"filter":filter,"startAt":start,"requestedCount":count,"sort":sort},callback);else return makeRequest("MapDLNAGetContainer",
"id",devid,"containerId",containerId,"containerType",containerType,"filter",filter,"startAt",start,"requestedCount",count,"sort",sort)};this.MapPlayer=function(url,block,rate,position,winType,x,y,w,h,callback,callbackParams){var playerWindow=new Object;playerWindow.type=winType;playerWindow.x=x;playerWindow.y=y;playerWindow.width=w;playerWindow.height=h;var params=new Object;if(callbackParams)params.callbackParams=callbackParams;params["ver"]="1.0";params["url"]=url;params["block"]=block;params["rate"]=
rate;if(position)params["playPos"]=position;params["window"]=playerWindow;asyncMakeRequest("MapPlayer",params,callback);playerWindow=null;params=null};this.MapPlayerRTSPVod=function(assetId,block,rate,position,winType,x,y,w,h,callback){var playerWindow=new Object;playerWindow.type=winType;playerWindow.x=x;playerWindow.y=y;playerWindow.width=w;playerWindow.height=h;var params=new Object;params["ver"]="1.0";params["id"]=assetId;params["block"]=block;params["rate"]=rate;if(position!=undefined&&(position!=
null&&(position!==""&&position>=0)))params["playPos"]=position*1E3;params["window"]=playerWindow;asyncMakeRequest("MapPlayer",params,callback);playerWindow=null;params=null};this.MapPlayerStop=function(winType,x,y,w,h,callback){var playerWindow=new Object;playerWindow.type=winType;playerWindow.x=x;playerWindow.y=y;playerWindow.width=w;playerWindow.height=h;asyncMakeRequest("MapPlayer",{"ver":"1.0","window":playerWindow},callback);playerWindow=null};this.MapPlayerSkip=function(url,rate,offset,winType,
x,y,w,h,callback,callbackParams){var playerWindow=new Object;playerWindow.type=winType;playerWindow.x=x;playerWindow.y=y;playerWindow.width=w;playerWindow.height=h;var params={"ver":"1.0","url":url,"rate":rate,"skip":offset,"window":playerWindow};if(callbackParams)params.callbackParams=callbackParams;asyncMakeRequest("MapPlayer",params,callback);playerWindow=null};this.MapPlayerMakePipPrimary=function(pipUrl,callback){var params=new Object;params["ver"]="1.0";params["url"]=pipUrl;params["window"]=
{type:"pip"};params["destwin"]={type:"main"};asyncMakeRequest("MapPlayer",params,callback)};this.MapPlayerSetVideoWinSize=function(url,winType,x,y,w,h,callback){var playerWindow=new Object;playerWindow.type=winType;playerWindow.x=x;playerWindow.y=y;playerWindow.width=w;playerWindow.height=h;asyncMakeRequest("MapPlayer",{"ver":"1.0","url":url,"window":playerWindow},callback)};this.DvrGetCheckPoint=function(callback){if(callback)asyncMakeRequest("PvrGetCheckPoint",{},callback);else return makeRequest("PvrGetCheckPoint")};
this.DvrSync=function(callback){if(callback)asyncMakeRequest("PvrSync",{},callback);else return makeRequest("PvrSync")};this.DvrRecord=function(loc,channelId,secs,t,d,start,repeat,fPad,bPad,locked,callback){var params=new Object;params["locator"]=loc;params["channelId"]=channelId;params["duration"]=secs;params["title"]=t;params["description"]=d;params["start"]=start;params["isPinLocked"]=locked;if(fPad)params["frontPad"]=fPad;if(bPad)params["backPad"]=bPad;var crontabInterval;if(repeat!=0){var recordingDate;
if(!start)recordingDate=new Date;else recordingDate=new Date(start*1E3);var repeatDays="";for(var i=0;i<repeat.length;i++)if(repeat[i]==7)repeatDays="0,"+repeatDays;else repeatDays+=repeat[i]+",";repeatDays=repeatDays.substring(0,repeatDays.length-1);crontabInterval=recordingDate.getMinutes()+" "+recordingDate.getUTCHours()+" * * "+repeatDays}if(crontabInterval)params["interval"]=crontabInterval;asyncMakeRequest("PvrSchedRecording",params,callback);params=null};this.DvrRecordEvent=function(eId,fPad,
bPad,locked,callback){log.trace("DvrRecordEvent: "+eId);var params=new Object;params["eventCrid"]=eId;params["isPinLocked"]=locked;if(fPad||fPad===0)params["frontPad"]=fPad;if(bPad||bPad===0)params["backPad"]=bPad;asyncMakeRequest("PvrSchedRecording",params,callback);params=null};this.DvrRecordSeries=function(sId,fPad,bPad,chan,event,locked,callback){log.trace("DvrRecordSeries: "+sId+" chan: "+chan+" event: "+event);var params=new Object;params["seriesCrid"]=sId;params["isPinLocked"]=locked;if(fPad)params["frontPad"]=
fPad;if(bPad)params["backPad"]=bPad;if(chan)params["channel"]=chan;if(event)params["event"]=event;asyncMakeRequest("PvrSchedRecording",params,callback);params=null};this.DvrUpdateRecord=function(id,duration,startTime,callback){if(duration!=undefined&&startTime!=undefined)if(callback)asyncMakeRequest("PvrUpdateRecording",{"recordingId":id,"duration":duration,"start":startTime},callback);else return makeRequest("PvrUpdateRecording","recordingId",id,"duration",duration,"start",startTime);else if(startTime!=
undefined){log.warn("DvrUpdateRecord(): duration is null!!!");if(callback)asyncMakeRequest("PvrUpdateRecording",{"recordingId":id,"start":startTime},callback);else return makeRequest("PvrUpdateRecording","recordingId",id,"start",startTime)}else if(duration!=undefined){log.warn("DvrUpdateRecord(): startTime is null!!!");if(callback)asyncMakeRequest("PvrUpdateRecording",{"recordingId":id,"duration":duration},callback);else return makeRequest("PvrUpdateRecording","recordingId",id,"duration",duration)}};
this.DvrUpdateOperation=function(id,fPad,bPad,locked,callback){var params=new Object;params["operationId"]=id;if(fPad)params["frontPad"]=fPad;if(bPad)params["backPad"]=bPad;if(locked!=undefined)params["isPinLocked"]=locked;asyncMakeRequest("MapPvrUpdateOperation",params,callback);params=null};this.DvrSetBookmark=function(recordingId,bookmark,callback){asyncMakeRequest("PvrSetBookmark",{"recordingId":recordingId,"position":bookmark},callback)};this.DvrAssetList=function(callback){asyncMakeRequest("PvrListRecording",
{},callback)};this.DvrListRequests=function(callback){if(callback)asyncMakeRequest("PvrListRequests",{},callback);else return makeRequest("PvrListRequests")};this.DvrListOperations=function(callback){if(callback)asyncMakeRequest("PvrListOperations",{},callback);else return makeRequest("PvrListOperations")};this.DvrListRecordings=function(callback){if(callback)asyncMakeRequest("PvrListRecordings",{},callback);else return makeRequest("PvrListRecordings")};this.DvrListRequestsOperationsRecordings=function(callback){if(callback)asyncMakeRequest("PvrBatchCommand",
{"commands":["PvrListRequests","PvrListOperations","PvrListRecordings"]},callback);else return makeRequest("PvrBatchCommand","commands",["PvrListRequests","PvrListOperations","PvrListRecordings"])};this.DvrGetRecords=function(cp,callback){if(callback)asyncMakeRequest("MapPvrGetRecords",{"checkPoint":cp},callback);else return makeRequest("MapPvrGetRecords","checkPoint",cp)};this.DvrGetConflicts=function(id,callback,callbackParams){var params=new Object;params={"opId":id};params.callbackParams=callbackParams;
asyncMakeRequest("MapPvrGetConflicts",params,callback)};this.DvrPause=function(callback){asyncMakeRequest("PvrPlayTrick",{"speed":0},callback)};this.DvrResume=function(callback){asyncMakeRequest("PvrPlayTrick",{"speed":100},callback)};this.DvrFastForward=function(speed,callback){asyncMakeRequest("PvrPlayTrick",{"speed":speed},callback)};this.DvrRewind=function(speed,callback){asyncMakeRequest("PvrPlayTrick",{"speed":-speed},callback)};this.DvrOffset=function(offset,callback){asyncMakeRequest("PvrPlaySkip",
{"offset":offset},callback)};this.DvrDelete=function(loc,callback){asyncMakeRequest("PvrDeleteRecording",{"locator":loc},callback)};this.DvrDeleteAll=function(callback){asyncMakeRequest("PvrDeleteAll",{},callback)};this.DvrDeleteRequest=function(id,callback){asyncMakeRequest("PvrDelete",{"requestId":id},callback)};this.DvrDeleteOperation=function(id,callback){asyncMakeRequest("PvrDelete",{"operationId":id},callback)};this.DvrDeleteRecording=function(id,callback){asyncMakeRequest("PvrDelete",{"recordingId":id},
callback)};this.DvrCancelRequest=function(id,callback){asyncMakeRequest("PvrCancel",{"requestId":id},callback)};this.DvrDeleteProtectOperation=function(id,state,callback,callbackParams){var params=new Object;params={"operationId":id,"protect":state};params.callbackParams=callbackParams;asyncMakeRequest("PvrDeleteProtect",params,callback)};this.DvrPinProtectOperation=function(id,state,callback,callbackParams){var params=new Object;params={"operationId":id,"protect":state};params.callbackParams=callbackParams;
asyncMakeRequest("PvrPinProtect",params,callback)};this.DvrDeleteProtectRequest=function(id,state,callback,callbackParams){var params=new Object;params={"requestId":id,"protect":state};params.callbackParams=callbackParams;asyncMakeRequest("PvrDeleteProtect",params,callback)};this.DvrPinProtectRequest=function(id,state,callback,callbackParams){var params=new Object;params={"requestId":id,"protect":state};params.callbackParams=callbackParams;asyncMakeRequest("PvrPinProtect",params,callback)};this.DvrStop=
function(callback){asyncMakeRequest("DvrStop",{},callback)};this.PvrStop=function(callback){asyncMakeRequest("PvrStop",{},callback)};this.DvrStopRecording=function(id,callback){asyncMakeRequest("PvrStopRecording",{"recordingId":id},callback)};this.VodSessionOpen=function(aid,typ,callback){asyncMakeRequest("VodSessionOpen",{"assetId":aid,"vodType":typ},callback)};this.VodSessionClose=function(callback){asyncMakeRequest("VodSessionClose",{},callback)};this.VodPlay=function(blocked,start,callback){asyncMakeRequest("VodPlay",
{"blocked":blocked,"start":start},callback)};this.VodPause=function(callback){asyncMakeRequest("VodPause",{},callback)};this.VodFastforward=function(num,denom,callback){asyncMakeRequest("VodFastforward",{"numerator":num,"denominator":denom},callback)};this.VodRewind=function(num,denom,callback){asyncMakeRequest("VodRewind",{"numerator":num,"denominator":denom},callback)};this.VodStop=function(callback){asyncMakeRequest("VodStop",{},callback)};this.VodGet=function(nam,callback){asyncMakeRequest("VodGet",
...
params,callback)};this.ConfigSet=function(nm,val,callback){if(callback)asyncMakeRequest("ConfigSet",{"name":nm,"value":val},callback);else return makeRequest("ConfigSet","name",nm,"value",val)};this.GetMWConfig=function(section,key,callback){asyncMakeRequest("GetMWConfig",{"section":section,"key":key},callback)};this.GetKeyMap=function(callback){asyncMakeRequest("GetKeyMap",{},callback)};this.EmulateRemoteKey=function(kc,ks){if(!!ks)asyncMakeRequest("EmulateRemoteKey",{"KeyCode":kc,"KeyState":ks});
else asyncMakeRequest("EmulateRemoteKey",{"KeyCode":kc})};this.VerifyPin=function(profId,type,pin,callback,callbackParams){var params=new Object;params={"profile":profId,"type":type,"pin":pin};params.callbackParams=callbackParams;asyncMakeRequest("VerifyPin",params,callback)};this.ResetPin=function(profId,type,pin,newpin,callback,callbackParams){var params=new Object;params={"profile":profId,"type":type,"masterpin":pin,"newpin":newpin};params.callbackParams=callbackParams;asyncMakeRequest("ResetPin",
params,callback)};this.GetPinState=function(profId,type){asyncMakeRequest("GetPinState",{"profile":profId,"type":type},callback)};this.ActivatePin=function(profId,type,pin,enable){asyncMakeRequest("ActivatePin",{"profile":profId,"type":type,"masterpin":masterpin,"activate":enable},callback)};this.GetProfileNames=function(callback,callbackParams){callback()};this.ProfileSetInitChan=function(profileid,newInitChan,callback,callbackParams){var params=new Object;if(callbackParams)params.callbackParams=
callbackParams;params.profileId=profileid;if(profileid.indexOf("MasterProfile")!=-1)params.keyword="master";params.Settings=new Object;params.Settings.initChannel=newInitChan;asyncMakeRequest("WriteProfile",params,callback)};this.ProfileGetInitChan=function(profileid,callback,callbackParams){var params=new Object;if(callbackParams)params.callbackParams=callbackParams;params.profileId=profileid;params.Settings=["initChannel"];asyncMakeRequest("ReadProfile",params,callback)};this.ProfileSetAgeRating=
function(profileid,newAgeRating,callback,callbackParams){newAgeRating=newAgeRating?newAgeRating:USER_AGE_RATING_OFF;var params=new Object;if(callbackParams)params.callbackParams=callbackParams;params.profileId=profileid;if(profileid.indexOf("MasterProfile")!=-1)params.keyword="master";params.Settings=new Object;params.Settings.ageRating=newAgeRating;asyncMakeRequest("WriteProfile",params,callback)};this.ProfileGetAgeRating=function(profileid,callback,callbackParams){var params=new Object;if(callbackParams)params.callbackParams=
...
{"mode":mode,"timeout":timeout,"time":time,"callbackParams":callbackParams},callback)};this.AcknowledgePowerManagerEvent=function(callback){asyncMakeRequest("AcknowledgePowerManagerEvent",{},callback)};this.PesGetAllEvents=function(filter,callback){if(callback)asyncMakeRequest("GetAllEvents",{"filter":filter},callback);else return makeRequest("PesGetAllEvents","filter",filter)};this.PesGetChannelsWithEvent=function(chanFilter,chanProps,eventFilter,callback){asyncMakeRequest("GetChannelsWithEvent",
{"ChanFilter":chanFilter,"ChanProps":chanProps,"EventFilter":eventFilter},callback)};this.PesGetEventsByChanId=function(chanId,filter,callback){if(callback)asyncMakeRequest("GetEventsByChanId",{"chanId":chanId,"filter":filter},callback);else return makeRequest("GetEventsByChanId","chanId",chanId,"filter",filter)};this.PesGetEventsByLcn=function(lcn,filter,callback){if(callback)asyncMakeRequest("GetEventsByLcn",{"lcn":lcn,"filter":filter},callback);else return makeRequest("GetEventsByLcn","lcn",lcn,
"filter",filter)};this.PesGetPfEventsByChanId=function(chanId){return makeRequest("GetPfEventsByChanId","chanId",chanId)};this.PesGetPfEventsByLcn=function(lcn){return makeRequest("GetPfEventsByLcn","lcn",lcn)};this.MapGetOnlineMode=function(callback){if(callback)asyncMakeRequest("MapGetOnlineMode",{},callback);else return makeRequest("MapGetOnlineMode")};this.writePVRProfile=function(profileid,pvrSettings,callback,callbackParams){var params=new Object;params.callbackParams=callbackParams;params.profileId=
profileid;if(profileid.indexOf("MasterProfile")!=-1)params.keyword="master";params.Settings=new Object;params.Settings.pvrSettings=new Object;params.Settings.pvrSettings.frontPad=pvrSettings.newFrontPad!=undefined?pvrSettings.newFrontPad:pvrSettings.frontPad;params.Settings.pvrSettings.backPad=pvrSettings.newBackPad!=undefined?pvrSettings.newBackPad:pvrSettings.backPad;params.Settings.pvrSettings.seriesDomain=pvrSettings.newSeriesDomain!=undefined?pvrSettings.newSeriesDomain:pvrSettings.seriesDomain;
params.Settings.pvrSettings.diskManagement=pvrSettings.newDiskManagement!=undefined?pvrSettings.newDiskManagement:pvrSettings.diskManagement;asyncMakeRequest("WriteProfile",params,callback)};this.readPVRProfile=function(profileid,callback,callbackParams){var params=new Object;if(callbackParams)params.callbackParams=callbackParams;params.profileId=profileid;if(profileid.indexOf("MasterProfile")!=-1)params.keyword="master";params.Settings=["pvrSettings"];asyncMakeRequest("ReadProfile",params,callback)};
this.writeViewSettingsProfile=function(profileid,langSettings,viewSettings,callback,callbackParams){var params=new Object;params.callbackParams=callbackParams;params.profileId=profileid;if(profileid.indexOf("MasterProfile")!=-1)params.keyword="master";params.Settings=new Object;params.Settings.viewSettings=new Object;params.Settings.viewSettings.lang=new Object;params.Settings.viewSettings.lang.code=langSettings.newCode!=undefined?langSettings.newCode:langSettings.code;params.Settings.viewSettings.lang.type=
langSettings.newType!=undefined?langSettings.newType:langSettings.type;params.Settings.viewSettings.transparency=viewSettings.newTransparency!=undefined?viewSettings.newTransparency:viewSettings.transparency;params.Settings.viewSettings.bannerTimeout=viewSettings.newBannerTimeout!=undefined?viewSettings.newBannerTimeout:viewSettings.bannerTimeout;params.Settings.viewSettings.epgStyle=viewSettings.newEpgStyle!=undefined?viewSettings.newEpgStyle:viewSettings.epgStyle;params.Settings.viewSettings.epgSpan=
viewSettings.newEpgSpan!=undefined?viewSettings.newEpgSpan:viewSettings.epgSpan;params.Settings.viewSettings.assetsStyle=viewSettings.newAssetsStyle!=undefined?viewSettings.newAssetsStyle:viewSettings.assetsStyle;params.Settings.viewSettings.settingsProtection=viewSettings.newSettingsProtection!=undefined?viewSettings.newSettingsProtection:viewSettings.settingsProtection;asyncMakeRequest("WriteProfile",params,callback)};this.readViewSettingsProfile=function(profileid,callback,callbackParams){var params=
new Object;if(callbackParams)params.callbackParams=callbackParams;params.profileId=profileid;if(profileid.indexOf("MasterProfile")!=-1)params.keyword="master";params.Settings=["viewSettings"];asyncMakeRequest("ReadProfile",params,callback)};this.writeOutputSettingsProfile=function(profileid,outputSettings,callback,callbackParams){var params=new Object;params.callbackParams=callbackParams;params.profileId=profileid;if(profileid.indexOf("MasterProfile")!=-1)params.keyword="master";params.Settings=new Object;
params.Settings.outputSettings=new Object;params.Settings.outputSettings.primary=outputSettings.newPrimary!=undefined?outputSettings.newPrimary:outputSettings.primary;params.Settings.outputSettings.hdmi=new Object;params.Settings.outputSettings.hdmi.resolution=outputSettings.hdmi.newResolution!=undefined?outputSettings.hdmi.newResolution:outputSettings.hdmi.resolution;params.Settings.outputSettings.hdmi.format=outputSettings.hdmi.newFormat!=undefined?outputSettings.hdmi.newFormat:outputSettings.hdmi.format;
params.Settings.outputSettings.hdmi.color=outputSettings.hdmi.newColor!=undefined?outputSettings.hdmi.newColor:outputSettings.hdmi.color;params.Settings.outputSettings.hdmi.audio=new Object;params.Settings.outputSettings.hdmi.audio.enable=outputSettings.hdmi.audio.newEnable!=undefined?outputSettings.hdmi.audio.newEnable:outputSettings.hdmi.audio.enable;params.Settings.outputSettings.hdmi.audio.delay=outputSettings.hdmi.audio.newDelay!=undefined?outputSettings.hdmi.audio.newDelay:outputSettings.hdmi.audio.delay;
params.Settings.outputSettings.spdif=new Object;params.Settings.outputSettings.spdif.enable=outputSettings.spdif.newEnable!=undefined?outputSettings.spdif.newEnable:outputSettings.spdif.enable;params.Settings.outputSettings.spdif.delay=outputSettings.spdif.newDelay!=undefined?outputSettings.spdif.newDelay:outputSettings.spdif.delay;params.Settings.outputSettings.tv=new Object;params.Settings.outputSettings.tv.aspectRatio=outputSettings.tv.newAspectRatio!=undefined?outputSettings.tv.newAspectRatio:
outputSettings.tv.aspectRatio;params.Settings.outputSettings.tv.start=outputSettings.tv.newStart!=undefined?outputSettings.tv.newStart:outputSettings.tv.start;params.Settings.outputSettings.scart=new Object;params.Settings.outputSettings.scart.format=outputSettings.scart.newFormat!=undefined?outputSettings.scart.newFormat:outputSettings.scart.format;params.Settings.outputSettings.scart.color=outputSettings.scart.newColor!=undefined?outputSettings.scart.newColor:outputSettings.scart.color;params.Settings.outputSettings.scart.enable=
outputSettings.scart.newEnable!=undefined?outputSettings.scart.newEnable:outputSettings.scart.enable;params.Settings.outputSettings.audio=new Object;params.Settings.outputSettings.audio.format=outputSettings.audio.newFormat!=undefined?outputSettings.audio.newFormat:outputSettings.audio.format;params.Settings.outputSettings.frontPanel=new Object;params.Settings.outputSettings.frontPanel.luminosity=outputSettings.frontPanel.newLuminosity!=undefined?outputSettings.frontPanel.newLuminosity:outputSettings.frontPanel.luminosity;
asyncMakeRequest("WriteProfile",params,callback)};this.readOutputSettingsProfile=function(profileid,callback,callbackParams){var params=new Object;if(callbackParams)params.callbackParams=callbackParams;params.profileId=profileid;if(profileid.indexOf("MasterProfile")!=-1)params.keyword="master";params.Settings=["outputSettings"];asyncMakeRequest("ReadProfile",params,callback)};this.SetVideoOutputSettings=function(resolution,type,callback,callbackParams){resolution=NAF.conf.hdmiComponent[resolution];
var params=new Object;params.id=resolution;if(type)params.type=type;params.callbackParams=callbackParams;asyncMakeRequest("MapSetVideoOutputPortSettings",params,callback)};this.GetVideoOutputSettings=function(resolution,callback){params=new Object;if(resolution)params.type=resolution;asyncMakeRequest("MapGetVideoOutputPortSettings",params,callback)};this.SetTVAspectRatio=function(aspectRatio,callback,callbackParams){var params=new Object;var ratio=aspectRatio.split(":");params.aspectWidth=parseInt(ratio[0],
10);params.aspectHeight=parseInt(ratio[1],10);params.callbackParams=callbackParams;asyncMakeRequest("MapSetVideoPortControlSet",params,callback)};this.MapGetDolbyEnabled=function(callback){asyncMakeRequest("MapGetDolbyEnabled",{},callback)};this.MapSetDolbyEnabled=function(isDolby,callback,callbackParams){asyncMakeRequest("MapSetDolbyEnabled",{enable:isDolby,callbackParams:callbackParams},callback)};this.SetAudioOutputSettings=function(format,type,callback,callbackParams){format=NAF.conf.audioFormat[format];
var params=new Object;params.id=format;if(type)params.type=type;params.callbackParams=callbackParams;asyncMakeRequest("MapSetAudioOutputPortSettings",params,callback)};this.GetAudioOutputSettings=function(format,callback){params=new Object;if(format)params.type=format;asyncMakeRequest("MapGetAudioOutputPortSettings",params,callback)};this.SetAudioOutputVolumeSettings=function(volumeSettings,type,callback){if(type)volumeSettings.type=type;asyncMakeRequest("MapSetAudioOutputVolumeSettings",volumeSettings,
callback)};this.GetAudioOutputVolumeSettings=function(type,callback,callbackParams){var params=new Object;if(callbackParams)params.callbackParams=callbackParams;if(type)params.type=type;asyncMakeRequest("MapGetAudioOutputVolumeSettings",params,callback)};this.GetHDDAvailability=function(callback){asyncMakeRequest("MapGetHDDAvailability",{},callback)};this.VidGetTSBInfo=function(callback){asyncMakeRequest("GetTSBInfo",{},callback)};this.VidGetTSBEventInfo=function(callback){asyncMakeRequest("GetTSBEventInfo",
{},callback)};this.SubscribePlayerPosition=function(frequency,callback){asyncMakeRequest("MAPSubscribeEvent",{"name":"MWPlayerPosition","frequency":frequency},callback)};this.UnsubscribePlayerPosition=function(callback){asyncMakeRequest("MAPUnsubscribeEvent",{"name":"MWPlayerPosition"},callback)};this.SubscribeTSBEventInfo=function(callback){asyncMakeRequest("MAPSubscribeEvent",{"name":"TSBEventInfo"},callback)};this.UnsubscribeTSBEventInfo=function(callback){asyncMakeRequest("MAPUnsubscribeEvent",
{"name":"TSBEventInfo"},callback)};this.AdjustUserAgeRating=function(ageRating,callback){asyncMakeRequest("AdjustUserAgeRating",{"tempAgeRating":ageRating},callback)};this.RevertUserAgeRating=function(callback){asyncMakeRequest("RevertUserAgeRating",{},callback)};this.GetDiagnostics=function(callback){asyncMakeRequest("GetDiagnostics",{},function(result){if(callback)callback(GetDiagnosticsCB(result))})};this.SendDiagMsg=function(result,targetIp,msg,callback){if(callback)asyncMakeRequest("SendTo",
{"method":"DiagResult","targetIP":targetIp,"result":result,"message":msg},callback);else return makeRequest("SendTo","method","DiagResult","targetIP",targetIp,"result",result,"message",msg)};this.SendDiagResp=function(result,targetIp,msg,dqId,callback){if(callback)asyncMakeRequest("QueryResult",{"method":"DiagResult","targetIP":targetIp,"result":result,"message":msg,"dqId":dqId},callback);else return makeRequest("QueryResult","method","DiagResult","targetIP",targetIp,"result",result,"message",msg,
"dqId",dqId)};this.GetStandbyModeSettings=function(callback){asyncMakeRequest("GetStandbyModeSettings",{},callback)};this.SetStandbyModeSettings=function(type,timeOut,startTime,endTime,weekDay,callback,callbackParams){var params=new Object;params={"autoStandby":type,"timeout":timeOut,"startTime":startTime,"endTime":endTime,"weekday":weekDay};if(callbackParams)params.callbackParams=callbackParams;asyncMakeRequest("SetStandbyModeSettings",params,callback)};this.GetNetworks=function(callback){callback()};
...
asyncMakeRequest("ReadProfile",params,callback)};function GetDiagnosticsCB(result){if(result){var diagResult=new Object;diagResult.hw=new Object;diagResult.hw.hdd=new Object;diagResult.hw.tuners=new Array;if(result.hw){diagResult.hw.hdd.available=result.hw.hdd.available;diagResult.hw.hdd.capacity=result.hw.hdd.capacity;diagResult.hw.hdd.temperature=result.hw.hdd.temperature;diagResult.hw.version=result.hw.version;diagResult.hw.interfaces=result.hw.interfaces!=null?result.hw.interfaces:"";diagResult.hw.cm=
result.hw.cm!=null?result.hw.cm:"";for(var i=0;i<result.hw.tuners.length;i++)diagResult.hw.tuners.push(result.hw.tuners[i])}diagResult.ioports=new Object;diagResult.ioports.hdmi=new Object;if(result.ioports){diagResult.ioports.hdmi.hdcpStatus=result.ioports.hdmi.hdcpStatus;diagResult.ioports.hdmi.status=result.ioports.hdmi.status;diagResult.ioports.hdmi.tvEdid=result.ioports.hdmi.tvEdid}diagResult.ca=new Object;if(result.ca){diagResult.ca.caCallback=result.ca.caCallback;diagResult.ca.ecmReception=
result.ca.ecmReception;diagResult.ca.emmReception=result.ca.emmReception;diagResult.ca.status=result.ca.status}diagResult.sw=new Object;if(result.sw){diagResult.sw.cmVersion=result.sw.cmVersion;diagResult.sw.lastSWUpdate=result.sw.lastSWUpdate;diagResult.sw.version=result.sw.version;if(result.sw.modules){diagResult.sw.modules=new Object;diagResult.sw.modules.nas=result.sw.modules.nas;diagResult.sw.modules.nps=result.sw.modules.nps;diagResult.sw.modules.sdk=result.sw.modules.sdk}}diagResult.transportstream=
new Object;if(result.transportstream){diagResult.transportstream.lockSignal=result.transportstream.lockSignal!=null?result.transportstream.lockSignal:"";diagResult.transportstream.freq=result.transportstream.freq!=null?result.transportstream.freq:"";diagResult.transportstream.modulation=result.transportstream.modulation!=null?result.transportstream.modulation:"";diagResult.transportstream.bitRate=result.transportstream.bitRate!=null?result.transportstream.bitRate:"";diagResult.transportstream.nid=
result.transportstream.nid!=null?result.transportstream.nid:""}diagResult.freqscan=new Object;if(result.freqscan){diagResult.freqscan.tsid=result.freqscan.tsid!=null?result.freqscan.tsid:"";diagResult.freqscan.quality=result.freqscan.quality!=null?result.freqscan.quality:0;diagResult.freqscan.level=result.freqscan.level!=null?result.freqscan.level:0}diagResult.chanstatus=new Object;if(result.chanstatus){diagResult.chanstatus.lockStatus=result.chanstatus.lockStatus!=null?result.chanstatus.lockStatus:
"";diagResult.chanstatus.ber=result.chanstatus.ber!=null?result.chanstatus.ber:"";diagResult.chanstatus.freq=result.chanstatus.freq!=null?result.chanstatus.freq:"";diagResult.chanstatus.symbolRate=result.chanstatus.symbolRate!=null?result.chanstatus.symbolRate:"";diagResult.chanstatus.modulation=result.chanstatus.modulation!=null?result.chanstatus.modulation:"";diagResult.chanstatus.snr=result.chanstatus.snr!=null?result.chanstatus.snr:"";diagResult.chanstatus.inversion=result.chanstatus.inversion!=
null?result.chanstatus.inversion:"";diagResult.chanstatus.quality=result.chanstatus.quality!=null?result.chanstatus.quality:0;diagResult.chanstatus.level=result.chanstatus.level!=null?result.chanstatus.level:0}return diagResult}else return null}this.GetBootupState=function(callback){asyncMakeRequest("GetBootupState",{},callback)};this.MapGetStartUpMode=function(callback){asyncMakeRequest("MapGetStartUpMode",{},callback)};this.MapSetStartUpMode=function(mode,callback){asyncMakeRequest("MapSetStartUpMode",
{"mode":mode},callback)};this.RemotePairing=function(callback){asyncMakeRequest("MapRF4CBind",{},callback)};this.RemoteUnbind=function(id,callback){var params=new Object;params.bindingId=id;asyncMakeRequest("MapRF4CUnbind",params,callback)};this.RemotePairingAbort=function(callback){asyncMakeRequest("MapRF4CAbortBind",{},callback)};this.GetCacheUpdateStatus=function(callback){asyncMakeRequest("AppGetCacheUpdateStatus",{},callback)};this.SetCacheEventListener=function(callback,params){asyncMakeRequest("AppSetCacheEventListener",
...
function(callback){asyncMakeRequest("MapSwCheckUpdate",{},callback)};this.MapSwStartDownload=function(callback){asyncMakeRequest("MapSwStartDownload",{},callback)};this.MapSwInstall=function(callback){asyncMakeRequest("MapSwInstall",{},callback)};this.MapSwReboot=function(callback){asyncMakeRequest("MapSwReboot",{},callback)};this.MapSwDownloadProgress=function(callback){asyncMakeRequest("MapSwDownloadProgress",{},callback)};this.MapSetAgeRating=function(newAgeRating,callback){newAgeRating=newAgeRating?
newAgeRating:USER_AGE_RATING_OFF;asyncMakeRequest("MapSetUserAgeRating",{"ageRating":newAgeRating},callback)}};
...
notifyView("model.state.settings.current.profile")}};this.processLoadCallback=function(param){var callbackKey=param[0];var url=param[1];if(self.loadCallbacks[callbackKey]===undefined){log.error("WebApp.Controller: could not identify callback "+"with key "+callbackKey);return}self.loadCallbacks[callbackKey].apply(self,[url]);delete self.loadCallbacks[callbackKey]};this.processOnCallback=function(param){var callbackKey=param[0];var url=param[1];var data=param[2];self.storeTransmittedModelData(url,data);
if(self.onCallbacks[callbackKey]===undefined){log.error("WebApp.Controller: could not identify 'on' "+"callback with key "+callbackKey);return}log.trace("WebApp.Controller: calling proxied listener for "+url);self.onCallbacks[callbackKey].apply(self,[url])};this.storeTransmittedModelData=function(url,data){try{var javascriptModelVariable=url.replace(/(\.)([0-9]+)/g,"[$2]");var javascriptStatement=javascriptModelVariable+" = data;";eval(javascriptStatement)}catch(ex){log.warn("WebApp.Controller: Cannot evaluate transmitted model data. "+
...
windowId,viewState,state,type){this.id=id;this.name=name;this.shortSynopsis=shortSynopsis;this.isAdult=isAdult;this.isViewable=isViewable;this.isEntitled=isEntitled;this.products=[];this.pictures=[];this.url=url;this.inFocus=inFocus;this.windowId=windowId;this.viewState=viewState;this.state=state;this.type=type;this.appMsg=new AppMessage;this.reservedKeys=[];this.appKeys=[];this.modelSets=[];this.media={assets:[]}}Application.create=function(){return new Application};function KeyMap(){this.VK_EXIT=
3;this.VK_BACK_SPACE=8;this.VK_OK=13;this.VK_ENTER=13;this.VK_KEYBOARD=16;this.VK_ACCEPT=30;this.VK_SPACE=32;this.VK_PAGE_UP=33;this.VK_PAGE_DOWN=34;this.VK_HOME=36;this.VK_LEFT=37;this.VK_UP=38;this.VK_RIGHT=39;this.VK_DOWN=40;this.VK_0=48;this.VK_1=49;this.VK_2=50;this.VK_3=51;this.VK_4=52;this.VK_5=53;this.VK_6=54;this.VK_7=55;this.VK_8=56;this.VK_9=57;this.VK_A=65;this.VK_B=66;this.VK_C=67;this.VK_D=68;this.VK_E=69;this.VK_F=70;this.VK_G=71;this.VK_H=72;this.VK_I=73;this.VK_J=74;this.VK_K=75;
this.VK_L=76;this.VK_M=77;this.VK_N=78;this.VK_O=79;this.VK_P=80;this.VK_Q=81;this.VK_R=82;this.VK_S=83;this.VK_T=84;this.VK_U=85;this.VK_V=86;this.VK_W=87;this.VK_X=88;this.VK_Y=89;this.VK_Z=90;this.VK_RED=403;this.VK_GREEN=404;this.VK_BLUE=406;this.VK_YELLOW=405;this.VK_DELETE=127;this.VK_HELP=156;this.VK_POWER=409;this.VK_CHANNEL_UP=427;this.VK_CHANNEL_DOWN=428;this.VK_VOLUME_UP=447;this.VK_VOLUME_DOWN=448;this.VK_MUTE=449;this.VK_INFO=457;this.VK_GUIDE=458;this.VK_BACK=461;this.VK_MENU=462;this.VK_PAUSE=
19;this.VK_REW=412;this.VK_STOP=413;this.VK_PLAY=415;this.VK_REC=416;this.VK_FF=417;this.VK_REW_SKIP=424;this.VK_FWD_SKIP=425;this.VK_FAV=433;this.VK_TELETEXT=459;this.VK_SUBTITLE=460}KeyMap.create=function(){return new KeyMap};function MediaAsset(id,name,URL,picture,type,mimeType,encoding,description,genre,date,size,duration,ageRating){this.id=id;this.name=name;this.URL=URL;this.picture=picture;this.type=type;this.mimeType=mimeType;this.encoding=encoding;this.description=description;this.genre=genre;
this.date=date;this.size=size;this.duration=duration;this.ageRating=ageRating}MediaAsset.create=function(){return new MediaAsset};function AnnouncementEvent(type,time,message,imageURL,timeout){this.type=type;this.time=time;this.message=message;this.imageURL=imageURL;this.timeout=timeout}AnnouncementEvent.create=function(){return new AnnouncementEvent};function Announcement(event,appId,appName,appImage,appUrl){this.event=event;this.id=appId;this.name=appName;this.image=appImage;this.url=appUrl}Announcement.create=
function(){return new Announcement};this.State=State;this.Application=Application;this.Player=Player;this.channels=[];this.state=new State;this.state.settings.current.profile=new Profile("","");this.Channel=Channel;this.keymap=new KeyMap;this.MediaAsset=MediaAsset;this.AnnouncementEvent=AnnouncementEvent;this.Announcement=Announcement};